...
import { AlertCircle, CheckCircle, ArrowRight, ShieldCheck, Zap } from 'lucide-react';
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs mb-4">
        <div className="bg-stone-50/70 p-3 rounded-xl border border-stone-100">
          ...
          <p className="text-stone-700 leading-relaxed">{action.why}</p>
        </div>
        ...
        <div className="bg-stone-50/70 p-3 rounded-xl border border-stone-100">
          ...
          <p className="text-stone-700 leading-relaxed font-medium">{action.expected_impact}</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between pt-2 border-t border-stone-100">
        <div className="flex items-center space-x-1.5 text-xs text-stone-500">
          ...
          <span>Agronomic AI Verified</span>
        </div>
