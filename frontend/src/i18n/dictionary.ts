...
export const DYNAMIC_DICTIONARY: Record<LanguageCode, Record<string, string>> = {
  ...
  hi: {
    ...
    "High-Res Farmland Satellite": "उच्च-रिज़ॉल्यूशन कृषि सैटेलाइट",
    "NDVI Canopy": "NDVI फसल छतरी",
    "Map / Terrain": "मानचित्र / भूभाग",
  ...
  bn: {
    ...
    "Google Satellite": "গুগল স্যাটেলাইট",
    "High-Res Farmland Satellite": "উচ্চ-রেজোলিউশন কৃষি স্যাটেলাইট",
    "NDVI Canopy": "NDVI ফসলের ছাদ",
    "Map / Terrain": "মানচিত্র / ভূসংস্থান",
    ...
    //remaining
    "Active Sustainable Agricultural Protocols": "সক্রিয় টেকসই কৃষি পদ্ধতি",
    "ECOLOGICAL HEALTH ASSESSMENT":"পরিবেশগত স্বাস্থ্য মূল্যায়ন",
    "Sustainability Rating":"টেকসইতার রেটিং",
    "Groundwater Score":"ভূগর্ভস্থ জলের স্কোর",
    "Aquifer Conservation":"জলাধার সংরক্ষণ",
    "Today’s Changes": "আজকের পরিবর্তন",
    "Soil Nitrogen decreased from 58 mg/kg to 28 mg/kg (Deficient)":"মাটির নাইট্রোজেন ৫৮ mg/kg থেকে কমে ২৮ mg/kg হয়েছে (ঘাটতি)",
    "Soil Health score dropped due to nutrient imbalance":"পুষ্টির ভারসাম্যহীনতার কারণে মাটির স্বাস্থ্য স্কোর কমেছে",
    "Chlorophyll synthesis risk flagged for vegetative rice":"শস্য বৃদ্ধির পর্যায়ে ধানের ক্লোরোফিল সংশ্লেষণে ঝুঁকি শনাক্ত হয়েছে",
    "What Should I Do Today?": "আজ আমার কী করা উচিত?",
    "Apply neem-coated urea or organic compost based on soil test target":
    "মাটি পরীক্ষার লক্ষ্যমাত্রা অনুযায়ী নিম-প্রলেপযুক্ত ইউরিয়া বা জৈব কম্পোস্ট প্রয়োগ করুন",
    "Split nitrogen application to prevent leaching losses":
    "নাইট্রোজেনের অপচয় রোধ করতে ধাপে ধাপে নাইট্রোজেন প্রয়োগ করুন",
    "Re-check soil NPK levels in 5 days after application":"প্রয়োগের ৫ দিন পর মাটির NPK মাত্রা পুনরায় পরীক্ষা করুন",
    "Projected Outcomes": "প্রত্যাশিত ফলাফল",
    "Soil Health Score:": "মাটির স্বাস্থ্য স্কোর:",
    "Est. Additional Cost:": "আনুমানিক অতিরিক্ত খরচ:",
    "Ecological Health Assessment": "পরিবেশগত স্বাস্থ্য মূল্যায়ন",
    "Sustainability Rating: A": "টেকসইতা রেটিং: A",
    "Krishi-Kalpa precision nutrient and irrigation intelligence has prevented excessive chemical runoff and preserved local aquifer levels across 2.4 acres.": "কৃষি-কালপার নির্ভুল পুষ্টি ও সেচ ব্যবস্থাপনার মাধ্যমে অতিরিক্ত রাসায়নিক প্রবাহ রোধ হয়েছে এবং ২.৪ একর জমিতে স্থানীয় ভূগর্ভস্থ জলস্তর সংরক্ষিত হয়েছে।",
    "Aquifer Conservation:": "জলাধার সংরক্ষণ:",
    "High": "উচ্চ",
    "Rainfall interlock & drip precision water saving": "বৃষ্টির সঙ্গে সমন্বিত ড্রিপ সেচের মাধ্যমে নির্ভুল জল সাশ্রয়",
    "Targeted soil-test guidance stops excess urea dumping": "মাটি পরীক্ষাভিত্তিক নির্দেশনা অতিরিক্ত ইউরিয়া প্রয়োগ রোধ করে",
    "Reduced synthetic N manufacturing & pumping diesel emissions": "সিন্থেটিক নাইট্রোজেন উৎপাদন ও ডিজেল পাম্পিং থেকে নির্গমন কমানো হয়েছে",
    "Target: >1.5% for microbial soil sponge structure": "লক্ষ্য: মাটির জীবাণুবান্ধব স্পঞ্জ গঠন বজায় রাখতে >১.৫%",
    "Precision Micro-irrigation with Rain Interlock": "বৃষ্টির সঙ্গে সমন্বিত নির্ভুল মাইক্রো-সেচ",
    "Soil-Test Targeted Nutrient Management": "মাটি পরীক্ষাভিত্তিক নির্দিষ্ট পুষ্টি ব্যবস্থাপনা",
    "Continuous Root Zone Moisture Telemetry": "মূল অঞ্চলের আর্দ্রতার ধারাবাহিক টেলিমেট্রি",
    "Voluntary Carbon Credit Tracking": "স্বেচ্ছাসেবী কার্বন ক্রেডিট ট্র্যাকিং",
    "Verified reduction in synthetic chemical inputs and precision water conservation creates measurable carbon offsets eligible for sustainable agriculture incentives and premium organic certifications.": "সিন্থেটিক রাসায়নিকের ব্যবহার হ্রাস এবং নির্ভুল জল সংরক্ষণের মাধ্যমে পরিমাপযোগ্য কার্বন অফসেট তৈরি হচ্ছে, যা টেকসই কৃষি প্রণোদনা ও প্রিমিয়াম জৈব সার্টিফিকেশনের জন্য উপযুক্ত।",
    "SOIL • WARNING": "মাটি • সতর্কতা",
    "Nitrogen Hunger in Root Zone": "মূল অঞ্চলে নাইট্রোজেনের ঘাটতি",
    "Available nitrogen is low (27.7 mg/kg). Top-dressing recommended.": "উপলব্ধ নাইট্রোজেনের মাত্রা কম (২৭.৭ mg/kg)। উপরিপ্রয়োগের পরামর্শ দেওয়া হচ্ছে।",
    "View Farm Plan": "সার পরিকল্পনা দেখুন",
  },
  mr: {
