    ...
    setTimeout(() => {
      if (actionType === 'irrigate') {
        ...
        setFarmState((prev) => ({
          ...
          active_scenario_title: 'Post-Irrigation Hydrated State',
          active_scenario_category: 'Remediated'
        }));
        ...
        setFarmState((prev) => ({
          ...prev,
          nitrogen: 62.0,
          active_scenario_title: 'Post-Fertigation Balanced Nitrogen',
          active_scenario_category: 'Remediated'
        }));
      } else if (actionType === 'amend_ph') {
        // Normalize pH
        setFarmState((prev) => ({
          ...prev,
          ph: 6.5,
          active_scenario_title: 'Lime/Gypsum pH Balanced',
          active_scenario_category: 'Remediated'
        }));
      }
      setIsAnalyzing(false);
