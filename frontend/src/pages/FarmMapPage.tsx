      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl p-6 border border-stone-200 shadow-sm flex flex-col justify-between">
            ...
            <svg viewBox="0 0 600 400" className="w-full h-full max-h-80 select-none">
              ...
              >
                ...
                <text x="60" y="110" fill="#a8a29e" fontSize="11">
                  Status: {tText(farmZones[0].status)} • Moisture: {farmZones[0].soil_moisture}% • N: {farmZones[0].nitrogen} mg/kg
                </text>
              </g>
              ...
              >
                ...
                <text x="60" y="230" fill="#a8a29e" fontSize="11">
                  Status: {tText(farmZones[1].status)} • Moisture: {farmZones[1].soil_moisture}% • N: {farmZones[1].nitrogen} mg/kg
                </text>
              </g>
              ...
              >
                ...
                <text x="60" y="338" fill="#a8a29e" fontSize="11">
                  Status: {tText(farmZones[2].status)} • Moisture: {farmZones[2].soil_moisture}% • N: {farmZones[2].nitrogen} mg/kg
                </text>
              </g>
            </svg>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 mt-4 pt-3 border-t border-stone-100 text-xs">
            ...
            <span className="flex items-center text-stone-600">
              <span className="w-3 h-3 rounded-full bg-red-500 mr-1.5"></span> {tText("Soil Moisture Deficit & Water Stress")}
            </span>
            <span className="flex items-center text-stone-600">
              <span className="w-3 h-3 rounded-full bg-amber-500 mr-1.5"></span> {tText("Nitrogen Deficiency Detected")}
            </span>
            <span className="flex items-center text-stone-600">
              <span className="w-3 h-3 rounded-full bg-blue-500 mr-1.5"></span> {tText("Soil Waterlogging & Anoxia Hazard")}
            </span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm flex flex-col justify-between">
          ...
          <div className="pt-4 mt-4 border-t border-stone-100 flex items-center justify-between">
            <span className="text-xs text-stone-400">Degradation: {tText(activeZone.degradation_risk + ' Risk')}</span>
            {activeZone.status !== 'Healthy' && (
              <button
