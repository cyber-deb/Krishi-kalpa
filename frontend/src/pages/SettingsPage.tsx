    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-stone-500 mt-0.5">
          Farm configuration, language preference, and IoT device parameters
        </p>
      </div>

      {savedToast && (
        <div className="bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3 rounded-xl text-xs font-bold flex items-center space-x-2">
      ...
      <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm">
        ...
        <p className="text-xs text-stone-500 mb-4">
          Select your preferred native Indian language for the entire platform interface.
        </p>
      ...
      <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          <div className="bg-stone-50 p-4 rounded-xl border border-stone-100">
            <span className="font-bold text-stone-900 block mb-1">Active Operation Mode</span>
            <p className="text-stone-600 mb-3">
              Switch between the Agronomic Simulation Engine and live ESP32 wireless hardware telemetry stream.
            </p>
            <button
            ...
            >
              ...
              <span>Mode: {isDemo ? 'Demo Simulation Active' : 'Live Hardware Stream Active'}</span>
            </button>
          </div>

          <div className="bg-stone-50 p-4 rounded-xl border border-stone-100">
            <span className="font-bold text-stone-900 block mb-1">ESP32 REST Telemetry Endpoint</span>
            ...
            <p className="text-[11px] text-stone-500">
              Hardware code is available in <code className="font-bold">hardware/esp32/esp32_sensor_code.ino</code>
            </p>
          </div>
        </div>
      </div>
