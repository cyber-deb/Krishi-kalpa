    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-stone-500 mt-0.5">
          {t('sustainability.subtitle')} • {tText("Carbon & Natural Resource Ledger")}
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-agri-950 via-agri-900 to-stone-900 text-white rounded-2xl p-6 shadow-md border border-agri-800 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <div className="flex items-center space-x-2 text-xs font-bold text-emerald-400 uppercase tracking-wider mb-1">
            ...
            <span>{tText("Ecological Health Assessment")}</span>
          </div>
          <h3 className="text-2xl sm:text-3xl font-bold font-serif text-white">
            {tText(`Sustainability Rating: ${sustainability.sustainability_rating}`)}
          </h3>
          <p className="text-sm text-stone-300 mt-2 max-w-xl leading-relaxed">
            {tText(`Krishi-Kalpa precision nutrient and irrigation intelligence has prevented excessive chemical runoff and preserved local aquifer levels across ${farmState.config.area_acres} acres.`)}
          </p>
        </div>
        ...
        <div className="flex items-center space-x-4 bg-stone-800/80 p-4 rounded-xl border border-stone-700 self-start md:self-auto">
          <div>
            ...
            <div className="text-[11px] text-stone-400">
              {tText("Aquifer Conservation:")} <span className="font-bold text-white">{tText("High")}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-2xl p-5 border border-stone-200 shadow-sm">
          ...
          <p className="text-xs text-stone-500">
            {tText("Rainfall interlock & drip precision water saving")}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-stone-200 shadow-sm">
          ...
          <p className="text-xs text-stone-500">
            {tText("Targeted soil-test guidance stops excess urea dumping")}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-stone-200 shadow-sm">
          ...
          <p className="text-xs text-stone-500">
            {tText("Reduced synthetic N manufacturing & pumping diesel emissions")}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-stone-200 shadow-sm">
          ...
          <p className="text-xs text-stone-500">
            {tText("Target: >1.5% for microbial soil sponge structure")}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm">
        <h3 className="text-base font-bold text-stone-900 mb-4 flex items-center space-x-2">
          ...
          <span>{tText("Active Sustainable Agricultural Protocols")}</span>
        </h3>
      ...
      <div className="bg-stone-100 p-4 rounded-2xl border border-stone-200 text-xs text-stone-600 flex items-start space-x-3">
        ...
        <div>
          <span className="font-bold text-stone-900 block mb-0.5">{tText("Voluntary Carbon Credit Tracking")}</span>
          <span>
            {tText("Verified reduction in synthetic chemical inputs and precision water conservation creates measurable carbon offsets eligible for sustainable agriculture incentives and premium organic certifications.")}
          </span>
        </div>
      </div>
    </div>
