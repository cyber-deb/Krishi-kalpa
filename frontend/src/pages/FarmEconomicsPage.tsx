    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm">
        <h3 className="text-base font-bold text-stone-900 mb-4 flex items-center space-x-2">
          ...
          <span>Input Expenditure & Profit Comparison</span>
        </h3>
          ...
          <table className="w-full text-left text-xs sm:text-sm">
            <thead>
              <tr className="border-b border-stone-200 text-stone-400 font-bold uppercase tracking-wider text-[11px]">
                ...
                <th className="py-3 px-4 text-emerald-700 text-right">Benefit / Impact</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-stone-100 text-stone-700 font-medium">
              <tr>
                <td className="py-3.5 px-4 font-bold text-stone-900">Fertilizer & Nutrition Cost</td>
                ...
                <td className="py-3.5 px-4 text-emerald-700 font-bold text-right">
                  Save ₹{(cur.fertilizer_cost - rec.fertilizer_cost).toLocaleString()}
                </td>
              </tr>
              <tr>
                <td className="py-3.5 px-4 font-bold text-stone-900">Water Pumping Electricity</td>
                ...
                <td className="py-3.5 px-4 text-emerald-700 font-bold text-right">
                  Save ₹{(cur.water_pumping_cost - rec.water_pumping_cost).toLocaleString()}
                </td>
              </tr>
              <tr>
                <td className="py-3.5 px-4 font-bold text-stone-900">Labor & Operations</td>
                ...
                <td className="py-3.5 px-4 text-emerald-700 font-bold text-right">
                  Save ₹{(cur.labor_and_operations - rec.labor_and_operations).toLocaleString()}
                </td>
              </tr>
              <tr className="bg-stone-50 font-bold text-stone-900">
                ...
                <td className="py-3.5 px-4 text-emerald-700 text-right">
                  -{economics.input_cost_reduction_percent}% reduction
                </td>
              </tr>
              <tr>
