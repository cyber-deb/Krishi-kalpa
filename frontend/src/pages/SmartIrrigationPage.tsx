...
export const SmartIrrigationPage: React.FC = () => {
  ...
  const { irrigation, farmState, executeAdvisorAction } = useFarmState();

  const isIrrigate = irrigation.action === 'IRRIGATE';
  const isDoNotIrrigate = irrigation.action === 'DO NOT IRRIGATE';
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm font-medium text-stone-700 mt-2 max-w-2xl leading-relaxed">
              <strong>Why?</strong> {irrigation.primary_reason}
            </p>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3 pt-3 border-t border-stone-100">
          {isIrrigate ? (
            ...
            >
              ...
              <span>Start Irrigation Cycle (2.5 hrs)</span>
            </button>
          ) : (
            <button
            ...
            >
              ...
              <span>Confirm Water Hold (Preserve Groundwater)</span>
            </button>
          )}
        </div>
      </div>
