    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-stone-500 mt-0.5">
          {t('irrigation.subtitle')} • {tText(farmState.config.irrigation_system)}
        </p>
      </div>
          ...
          <div>
            <div className="flex items-center space-x-2 mb-1">
              ...
              <span className="text-xs font-semibold text-stone-600">
                {tText("Next Evaluation in")} {irrigation.next_check_hours} {tText("hours")}
              </span>
            </div>
            ...
            <p className="text-sm font-medium text-stone-700 mt-2 max-w-2xl leading-relaxed">
              <strong>{tText("Why?")}</strong> {tText(irrigation.primary_reason)}
            </p>
          </div>
          ...
          <div className="flex items-center space-x-3 bg-white p-4 rounded-xl border border-stone-200 shadow-sm self-start md:self-auto">
            ...
            <div>
              ...
              <div className="text-[11px] text-stone-500">
                {pumpActive ? tText("Delivering Drip Flow") : tText("Motors Standby")}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl p-5 border border-stone-200 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-stone-400 uppercase tracking-wider">{tText("Current Moisture")}</span>
          ...
          <div className="text-xs text-stone-500">
            {tText("Target: 65% (Field Capacity)")}
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-stone-200 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-stone-400 uppercase tracking-wider">{tText("Precipitation")}</span>
          ...
          <div className="text-xs text-stone-500">
            {tText("Expected:")} {farmState.expected_rainfall} mm
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-stone-200 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-stone-400 uppercase tracking-wider">{tText("Water Conserved")}</span>
        ...
        <div className="bg-white rounded-2xl p-5 border border-stone-200 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-stone-400 uppercase tracking-wider">{tText("Pumping Cost Saved")}</span>
      ...
      <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm">
        <h3 className="text-base font-bold text-stone-900 mb-3 flex items-center space-x-2">
          ...
          <span>{tText("Agronomic Irrigation Advice")}</span>
        </h3>
